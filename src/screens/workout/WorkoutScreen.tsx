        ...
        <div className="space-y-3">
          ...
          {extraLogged.map((le) => {
            ...
            return (
              ...
              >
                <ExerciseGif images={ex.images} alt={ex.name} animate className="h-16 w-16 shrink-0" />
...
function PlanCard({
  ...
  return (
    <button onClick={onClick} className="card press flex w-full items-center gap-3 p-2.5 text-left">
      <ExerciseGif images={planned.images} alt={planned.name} animate className="h-16 w-16 shrink-0" />
      <div className="min-w-0 flex-1">
